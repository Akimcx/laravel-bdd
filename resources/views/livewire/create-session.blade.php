<div class="container bg-inherit dark:text-slate-200">
    ...
    <x-form class="mt-4 grid gap-4" wire:submit='store'>
        ...
        <div class="bg-inherit">
            <x-form.select wire:model.change.number='course_id' name='course_id' label='Cours'>
        ...
        <div class="bg-inherit">
            <x-form.select name="instructor_id" wire:model.change.number='instructor_id' label="Professeur">
                <option value="">Choisir</option>
                @foreach ($instructors as $instructor)
                    <option selected="{{ sizeof($schools) === 1 }}" value="{{ $instructor->id }}">
