<div class="container dark:text-slate-200">
    ...
    <x-form class="mt-4 grid gap-4" wire:submit="{{ $edit ? 'edit' : 'store' }}">
        ...
        <x-form.select class="w-full" :disabled="$schools->isEmpty()" wire:model.change.number='school_id' name='school_id'
            label='Écoles'>
        ...
        <x-form.select class="w-full" multiple wire:model.change='courseModel' name='course' label='Cours'>
